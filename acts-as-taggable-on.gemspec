...
Gem::Specification.new do |s|
  ...
  s.files = [
    "CHANGELOG",
     ...
     "lib/acts_as_taggable_on/cache.rb",
     "lib/acts_as_taggable_on/collection.rb",
     "lib/acts_as_taggable_on/core.rb",
     "lib/acts_as_taggable_on/ownership.rb",
     "lib/acts_as_taggable_on/related.rb",
     "lib/acts_as_tagger.rb",
     "lib/compatibility/Gemfile",
     "lib/compatibility/active_record_backports.rb",
     "lib/compatibility/postgresql.rb",
     "lib/tag.rb",
     "lib/tag_list.rb",
     "lib/tagging.rb",
     "lib/tags_helper.rb",
