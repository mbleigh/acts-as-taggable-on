...
describe "Tag Expressions" do
  ...
  it "should be able to parse tags and operators" do
  	ActsAsTaggableOn::Expression::Parse::parse_expression("test+test2-test3-test4&test5&test6").length.should equal(11)
  end

  it "should ignore whitespace" do
    ActsAsTaggableOn::Expression::Parse::parse_expression("test  +  test2 - test3- test4& test5 & test  6").length.should equal(11)
  end

  it "should ensure first index is an operator" do
    list1 = ActsAsTaggableOn::Expression::Parse::parse_expression("test+test2-test3-test4&test5&test6")
    ActsAsTaggableOn::Expression::Parse::fixed_expression_array(list1).length.should equal(12)

    list2 = ActsAsTaggableOn::Expression::Parse::parse_expression("&test+test2-test3-test4&test5&test6")
  ...
  it "should handle repeated operators" do
    parse1 = ActsAsTaggableOn::Expression::Parse::parse_expression("test++test2--test3&&test4")
    parse2 = ActsAsTaggableOn::Expression::Parse::parse_expression("test+test2-test3&test4")
  ...
  it "should produce same result as ActiveRecord chaining in simple cases" do
    ...
    dina = TaggableModel.create(:name => 'Steve+Molly', :tag_list => "sad, strong, lazy, grumpy")
