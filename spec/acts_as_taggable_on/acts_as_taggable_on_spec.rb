...
describe "Acts As Taggable On" do
  ...
  describe "Related Objects" do
    ...
    context "Inherited Models" do
      ...
      it "should not include the object itself in the list of related objects" do
        taggable1 = InheritingTaggableModel.create!(:name => "InheritingTaggable 1")
        taggable2 = TaggableModel.create!(:name => "InheritingTaggable 2")
        ...
        taggable1.find_related_tags_for(TaggableModel).should include(taggable2)
  ...
  describe "Matching Contexts" do
    ...
    context "Inherited Models" do
      it "should find objects with tags of matching contexts" do
        taggable1 = InheritingTaggableModel.create!(:name => "Taggable 1")
        taggable2 = InheritingTaggableModel.create!(:name => "Taggable 2")
        taggable3 = InheritingTaggableModel.create!(:name => "Taggable 3")
        taggable4 = TaggableModel.create!(:name => "Taggable 4")
