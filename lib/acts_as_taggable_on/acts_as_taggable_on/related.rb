  ...
  module Related
    ...
    module InstanceMethods
      def matching_contexts_for(search_context, result_context, klass, options = {})
        ...
        klass.all.apply_finder_options({ :select     => "#{klass.table_name}.*, COUNT(#{ActsAsTaggableOn::Tag.table_name}.#{ActsAsTaggableOn::Tag.primary_key}) AS count",
                       ...
                       :group      => group_columns,
                       :order      => "count DESC" }.update(options), true)
      end
